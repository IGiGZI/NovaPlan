...
function Search() {
	...
	const handleGenerate = async () => {
		if (!selected) return;
		// For careers with sub_fields, require sub-field and level
				...
				<div className="max-w-2xl mx-auto px-4 pb-12">
					...
					{selected && (
						<div className="mt-6 bg-linear-to-br from-purple-900/20 to-transparent backdrop-blur-sm border border-purple-500/30 rounded-xl p-6 space-y-4">
							...
							{/* Level picker — shown after sub-field is selected */}
							{selectedSubField && (
							...
							<button
								...
								disabled={loading || (selected.sub_fields?.length > 0 && (!selectedSubField || !experienceLevel))}
